...
function PatientsPage() {
    ...
    const handleSendVideo = ()=>{
        if (recordedVideo && videoTitle) {
            ...
            alert('Video instruction "'.concat(videoTitle, '" sent successfully to ').concat(selectedPatient === null || selectedPatient === void 0 ? void 0 : selectedPatient.name));
        }
    };
...
//# sourceMappingURL=_eb83b1a3._.js.map