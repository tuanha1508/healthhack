...
async function POST(request) {
    try {
            ...
            const mockTranscription = [
                {
                    ...
                    text: "Hello, this is Dr. Smith."
                },
                {
                    start: 2.5,
                    end: 5.0,
                    text: "Today we'll practice a memory exercise."
                },
                {
                    start: 5.0,
                    end: 8.0,
                    text: "Please watch carefully and follow along."
                },
                {
                    start: 8.0,
                    end: 11.0,
                    text: "First, I want you to look at these objects."
                },
                {
                    start: 11.0,
                    end: 14.0,
                    text: "Try to remember them in order."
                },
                {
                    start: 14.0,
                    end: 17.0,
                    text: "We'll review them together at the end."
                },
                {
                    start: 17.0,
                    end: 20.0,
                    text: "Take your time and don't rush."
                }
            ];
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const formattedTranscription = data.segments?.map((segment)=>({
                start: segment.start,
                end: segment.end,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__13e2ecc5._.js.map